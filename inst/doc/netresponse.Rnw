...
versions. Your feedback and contributions are
welcome\footnote{leo.lahti@iki.fi}.
...
<<probs>>=
response.probabilities <- sample2response(model, subnet.id, D)
@ 
...
\bibitem[Honkela {\em et~al.}(2008)Honkela, Sepp{\"a}, and
  Alhoniemi]{Honkela08}
...
\bibitem[Kurihara {\em et~al.}(2007)Kurihara, Welling, and
  Vlassis]{Kurihara07nips}
